...
<body>
    ...
    <section class="center">
        ...
        <div id="user-exists" class="overlay">
            <div class="popup">
                <h2>Λάθος πληροφορίες!</h2>
                <a class="close" href="#">&times;</a>
                <div class="content">
                    Παρακαλώ δώστε ξανά τις πληροφορίες. Το όνομα χρήστη ή το email που δώσατε χρησημοποιείται απο άλλο λογαριασμό
                </div>
            </div>
        </div>
        <div id="wrong-data" class="overlay">
            <div class="popup">
                <h2>Λάθος Στοιχεια!</h2>
                <a class="close" href="#">&times;</a>
                <div class="content">
                    Λάθoς κωδικός πρόσβασης η λάθος όνομα χρήστη!
                </div>
            </div>
        </div>
