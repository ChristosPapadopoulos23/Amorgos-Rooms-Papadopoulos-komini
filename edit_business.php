...
<head>
    ...
    <link rel="preconnecat" href="https://fonts.googleapis.com">
...
<script>
    ...
    function change_values() {
        ...
        document.getElementById('name_l').value="<?php echo $name;?>";
        document.getElementById('comments').value="<?php echo $description;?>";
        if(document.getElementById('comments').value==0){
            document.getElementById('comments').value='';
        }
        document.getElementById('phone').value="<?php echo $phone;?>";
        document.getElementById('phone_l').value="<?php echo $phone;?>";
        document.getElementById('mobile').value="<?php echo $mobile;?>";
        document.getElementById('mobile_l').value="<?php echo $mobile;?>";
        document.getElementById('email').value="<?php echo $email;?>";
        document.getElementById('email_l').value="<?php echo $email;?>";
        document.getElementById('area').value="<?php echo $location;?>";
        document.getElementById('area_l').value="<?php echo $location;?>";
        document.getElementById('link').value="<?php echo $url;?>";
    };
